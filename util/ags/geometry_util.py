...
def geodesic_angle_to_circular_angle(angle, azumith_zero_direction="N"):
    """
    ...
    :return:
    """
    circular_angle = angle if angle > 0 else angle + 360
    if azumith_zero_direction == "N":
        return circular_angle
    elif azumith_zero_direction == "E":
        return circular_angle - 90 if circular_angle >= 90 else circular_angle - 90 + 360
    elif azumith_zero_direction == "S":
        return circular_angle - 180 if circular_angle >= 180 else circular_angle - 180 + 360
    else:
        return circular_angle - 270 if circular_angle >= 270 else circular_angle - 270 + 360
